...
class Faculty extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('faculty_name', 'length', 'max'=>250),
			array('faculty_code', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, faculty_name, faculty_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'faculty_name' =>  Yii::t('core','Faculty Name'),
			'faculty_code' =>  Yii::t('core','Faculty Code'),
		);
	}
