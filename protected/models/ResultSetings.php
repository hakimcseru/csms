...
/**
 * This is the model class for table "result_setings".
 *
 * The followings are the available columns in table 'result_setings':
 * @property integer $id
 ...
 */
class ResultSetings extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ResultSetings the static model class
	 */
