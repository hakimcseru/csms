...
<h1><?php echo Yii::t('core','Create Student Remission') ?></h1>


<form method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/collection/remission" id="searchForm" class="well form-search">	
...
<div class="tab-pane" id="present_enrollment_info">
     ...
     <div style="width:50%; height: auto; float: left;">
         ...
         <?php  if($model) echo $this->renderPartial('_form_remission', array('model'=>$model,'model2'=>$model2)); ?>
