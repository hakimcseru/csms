...
<div class="marksheet page">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" >
          ...
          <tr>
          	<td align="center" valign="top" style="text-aligh:center !important; height:380px !important;">
                        	...
                        	<td class="off_padding">
                            	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="formatting2">
									...
									<?php if(trim($model->result)){?>
										...
										<?php if($sub->student_subject_marks<$sub->subject_min_mark){?>
										<?php  echo '<u class="ured">'.Bndate::t(($sub->student_subject_marks)).'</u>';?>
										<?php } else echo Bndate::t(($sub->student_subject_marks));?>
										</td>
									<?php } else {?>
