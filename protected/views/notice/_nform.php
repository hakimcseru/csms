<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<a href="#" onclick="jQuery.ajax({'url':'/temp_project/csms/en/notice/getIds','type':'GET','cache':false,'data':jQuery(this).parents('form').serialize(),'success':function(html){jQuery('#StudentEnrollmentInfo_student_id').html(html)}});" >load</a>
	

<?php echo $form->listBox($model,'student_id', array(''=>'')); ?>
	<!--<div class="actions offset7">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Add Student' : 'Update Records',array('class'=>'btn-primary')); ?>
	</div>-->
