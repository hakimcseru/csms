...
<div class="vertical_card_wrapper">
        ...
        <div class="info_wrapper">
            <ul>
                <li class="namefont" style="line-height:23px;"><?php echo $detail->student_name;?></li>
			...
			<div class="tsign_wrapper">
				<div class="right">
					<ul>
						<li><img src="<?php echo Yii::app()->request->getBaseUrl(TRUE)?>/images/6.jpg" width="78" height="26" alt="" title="" /></li>
						<li>সভাপতি</li>
					</ul>
				</div>
			</div>
