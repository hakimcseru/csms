...
?>
 ...
 <div class="vertical_card_wrapper">
            ...
            <ul>
               ...
               <?php echo $mod->department->department_name;?>
                ...
                <li>
                    <label>শ্রেণী</label>
                    <span>:</span>
                    <?php echo CourseSemesterLebel::model()->semesterLebel($mod->course_id,$mod->semester);?>
                </li>
                <li>
                    <label>দল</label>
                    <span>:</span>
        ...
        <div class="address_wrapper">ছায়ানট সংস্কৃতি-ভবন, বাড়ি ৭২, সড়ক ১৫-এ, ধানমণ্ডি আ/এ, ঢাকা- ১২০৯ </div>
