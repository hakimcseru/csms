...
$tot_fm2=ClassRoutine::model()->findAll("session_id=".$model->session_id." and weekday='".$model->weekday."' group by faculty_member_id");
...
//echo "session_id=".$session_id." and faculty_member_id=".$model->member_pk." group by calendar_id,weekday";
$tot_class=ClassRoutine::model()->findAll("session_id=".$model->session_id." and faculty_member_id=".$tot_fm->faculty_member_id."  and weekday='".$model->weekday."' group by calendar_id");
//echo count($tot_class);
$final_res=array();
...
$tot_presence=FacultyMemberAttendanceData::model()->findAll("date in ($comma_separated) and date not in ($comma_dhd)  and member_id=".$tot_fm->faculty_member_id." group by date");
...
?>
 ...
 <tr>
                    	<td><?php echo $tot_fm->facultyMember->member_id;?></td>
                        <td><?php echo $tot_fm->facultyMember->member_name;?></td>
...
//echo "session_id=".$session_id." and faculty_member_id=".$model->member_pk." group by calendar_id,weekday";
$tot_class=ClassRoutine::model()->findAll("session_id=".$model->session_id." and additional_faculty_member_id='".$tot_fm->additional_faculty_member_id."' and weekday='".$model->weekday."' group by calendar_id");
//echo count($tot_class);
$final_res=array();
