...
$tot_fm2=ClassRoutine::model()->findAll(array('group'=>'additional_faculty_member_id','distinct'=>true,'condition'=>"session_id=".$model->session_id." and weekday='".$model->weekday."'"));
...
?>
 ...
 <tr>
                    	<td><?php echo $tot_fm->facultyMember->member_id; $ssd[$tot_fm->faculty_member_id]=$tot_fm->faculty_member_id;?></td>
