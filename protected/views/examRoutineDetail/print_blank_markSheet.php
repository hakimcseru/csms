...
<tr><td>
<h3 style="text-align:center">ছায়ানট সঙ্গীতবিদ্যায়তন</h3>
...
<h4><span style="width:50%; float:left;">বিষয়: <?php echo $model->subject->subject_name;?>, পূর্ণমান: <?php 
//echo "session='".$model->session_id."' and course='".$model->course_id."' and department='".$model->department_id."' and subject='".$model->subject_id."' and semester='".$model->semester_id."' and batch_id='".$model->batch_id."' and batch_group='".$model->batch_group_id."'";
$dfsre=Examsetting::model()->find("session='".$model->session_id."' and course='".$model->course_id."' and department='".$model->department_id."' and subject='".$model->subject_id."' and semester='".$model->semester_id."' and batch_id='".$model->batch_id."' and batch_group='".$model->batch_group_id."'");


if($dfsre) echo Bndate::t($dfsre->full_mark);?></span><span style="width:50%; float:right;text-align:right">কক্ষ: <?php echo Bndate::t($model->room->room_no)?>,  তারিখ: <?php echo Bndate::t($model->exam_date->exam_date,true)?></span></h4>
...
{ echo '</table>';
?>
<table style="margin:10px" cellpadding="5" width="98%">
<tr><td>
<div class="signature">
<br>
