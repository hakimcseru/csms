...
?>				
					...
					<input type="text" <?php if($value) echo 'value="'.$value->marks.'"';  else echo "";?> name="<?php echo  $student->student_id;?>_marks[]"  style="height:25px;"/>
					<input type="hidden" value="<?php echo $teacher->faculty_member_id;?>"  name="<?php echo  $student->student_id;?>_ts[]" style="height:25px;" />
