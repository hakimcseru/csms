<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model,'card_type', array('student-1'=>'শিক্ষার্থী-১','student-2'=>'শিক্ষার্থী-২','student-3'=>'শিক্ষার্থী-৩','teacher'=>'শিক্ষক'),array('class'=>'span5', 'maxlength'=>20)); ?>
      <?php echo $form->dropDownListRow($model, 'calendar_name', CHtml::listData(ExamRoutine::model()->findAll(array('order' => 'name')), 'id', 'name'), array('empty' => 'Select here....',  'maxlength' => 20, 'class'=>'span3', 'style'=>'height:30px;')); ?>
