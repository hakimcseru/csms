...
<table style="margin:10px" class="tdata" cellpadding="5" width="98%">
  ...
  <tr>
    <td><h2 style="text-align:center;margin-bottom:0 !important;">দল: <?php echo $batch_group_name;?>&nbsp;&nbsp;&nbsp; শ্রেণি: <?php echo $semester_name;?></h2></td>
  </tr>
 ...
 <?php } ?>
			...
			//$cp=ExamRoutineDetail::model()->findAll($where." and batch_section_id=".$sec['batch_section_id']." order by t.exam_date.exam_date asc");
