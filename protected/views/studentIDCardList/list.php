...
<?php $t=0;?>
<form action="<?php echo Yii::app()->createUrl('studentIDCardList/create');?>" method="POST">
...
?>
<?php 
if($mod->full_free=="Yes" || $mod->enrollment_status=="Reexam" ) $clear_payment=1;
else 
...
if($final_res || $mod->enrollment_status=="Reexam")
{

if(isset($total_holiday) )
{
...
?>
						...
						if(isset($att_set) || $mod->enrollment_status=="Reexam")
						{
						if((isset($att_set) && $att_set->min_allendance<=$total_pre) || $mod->enrollment_status=="Reexam")
						{
...
<td><?php if($mod->enrollment_status!="Reexam") echo $total_pre;?>%</td>
