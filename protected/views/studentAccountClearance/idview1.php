    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           <td align="center" style="font-size:13px !important;" >
            	কার্যক্রম: <?php echo Bndate::t($st->course->course_name);?>, বিভাগ: <?php echo Bndate::t($st->department->department_name);?>, শ্রেণি: <?php echo Bndate::t(CourseSemesterLebel::model()->semesterLebel($st->course_id,$st->semester));?>, দল: <?php echo Bndate::t($st->batchgroup->group_name);?>, <br />
