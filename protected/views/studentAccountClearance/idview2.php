    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center" style="font-size:13px !important;">
            	কার্যক্রম: <?php echo Bndate::t($st->course->course_name);?>, বিভাগ: <?php echo Bndate::t($st->department->department_name);?>, আবর্তন: <?php echo $st->batch->batch_id;?>, দল: <?php echo Bndate::t($st->batchgroup->group_name);?>, <br />
