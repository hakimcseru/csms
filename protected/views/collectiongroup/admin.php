...
$this->breadcrumbs=array(
	...
	Yii::t('core','Manage Student Collection Groups'),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('student-collection-group-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('core','Manage Student Collection Groups') ?></h1>

<?php $this->widget('bootstrap.widgets.BootButton', array(
    'label'=>Yii::t('core','Create'),
    'type'=>'primary', // null, 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
    'size'=>'normal', // null, 'large', 'small' or 'mini'
	'url'=>Yii::app()->createUrl('collectiongroup/create'),
)); ?>
&nbsp;
...
<?php $this->widget('bootstrap.widgets.BootGridView',array(
	'id'=>'student-collection-group-grid',
...
<script type="text/javascript">
	...
	{
		baseUrl = '<?php echo Yii::app()->urlManager->createUrl('collectiongroup/export'); ?>';
		queryString = $.fn.yiiGridView.getUrl("student-collection-group-grid");
