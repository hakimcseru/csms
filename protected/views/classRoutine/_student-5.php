...
<style>
	...
	.bdr_left{border-left:2px solid #ccc !important}
</style>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td>
    	<h1 style="text-align:center;margin-bottom:0 !important;"><?php echo $department_name;?></h1>
    </td>
  </tr>
  <tr>
    <td>
		   ...
		   ?>
            <td class="no_padding">
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="routine_tbl">
                  ...
                  <tr>
				   <?php foreach($cperiod as $per):
					$srr=ClassRoutine::model()->find($where."  and weekday='".$cg['weekday']."' and class_period_id=".$per['class_period_id']);
