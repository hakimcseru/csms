...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><h1 style="text-align:center;margin-bottom:0 !important;"><?php echo $course_name;?></h1></td>
  </tr>
  <tr>
    <td><h2 style="text-align:center;margin-bottom:0 !important;"><?php echo Bndate::BanglaWeekDay($weekdayw['weekday']);?></h2></td>
  </tr>
  <tr>
    <td><h2 style="text-align:center; margin-bottom:0 !important;">দল: <?php echo $batch_group_name;?></h2></td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
  </tr>
