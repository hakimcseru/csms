...
class FinalDataController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['AttendanceFinalData'];
		...
		if(Yii::app()->request->isAjaxRequest)
		{
			echo CJSON::encode(array(
				'status'=>'failure',
				'url'=>  Yii::app()->createUrl('attendance/finalData/create'),
	...
	public function actionUpdate($id)
	{
		...
		if(Yii::app()->request->isAjaxRequest)
		{
			echo CJSON::encode(array(
				'status'=>'failure',
				'url'=>  Yii::app()->createUrl('attendance/finalData/update', array('id'=>$id)),
				'div'=>$this->renderPartial('_form', array('model'=>$model), true)
			));
			exit;
		}
	...
	public function actionIndex()
	{
		...
		$model=new AttendanceFinalData('search');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='attendance-final-data-form')
		{
