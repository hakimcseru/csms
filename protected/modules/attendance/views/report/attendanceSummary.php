...
<?php $this->widget('ext.groupgridview.BootGroupGridView',array(
	...
	'dataProvider'=>$model->allAttendanceSummary(),
	//'filter'=>$model,
	...
	'extraRowExpression'=>'',
	'columns'=>array(
		'core_employee_name'=>array(
			'name'=>$model->getAttributeLabel('core_employee_name'),
			'value'=>  'Bndate::t($data["core_employee_name"])',
			'type'=>'raw',
		),
            
            'core_department_name'=>array(
			'name'=>$model->getAttributeLabel('core_department_name'),
			'value'=>  'Bndate::t($data["core_department_name"])',
			'type'=>'raw',
		),
