<?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
	...
	<div class="control-group " style="margin-bottom:0;"><label for="AttendanceCalendar_note" class="control-label"></label><div class="controls"><input type="checkbox" id="selecctall"/> Selecct All</div></div>
	
 <?php echo $form->checkBoxListInlineRow($model, 'courses', CHtml::listData(Course::model()->findAll(), 'course_pk', 'course_name'),array('class'=>'checkbox1')); ?>
