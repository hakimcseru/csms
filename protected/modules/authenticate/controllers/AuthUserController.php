...
{
$model->attributes=$_POST['AuthUser'];
$model->password=md5($_POST['AuthUser']['password']);
if($model->save())
...
{
$model=new AuthUser('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['AuthUser']))
$model->attributes=$_GET['AuthUser'];
...
{
$model=AuthUser::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='auth-user-form')
{
