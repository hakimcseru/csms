...
'users'=>array('*'),
	...
	{
		$model=new AuthModule;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['AuthModule']))
		{
			$model->attributes=$_POST['AuthModule'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('AuthModule');
	...
	{
		$model=new AuthModule('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AuthModule']))
			$model->attributes=$_GET['AuthModule'];
	...
	{
		$model=AuthModule::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='auth-module-form')
		{
