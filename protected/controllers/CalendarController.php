...
'users'=>array('*'),
	...
	public function actionView($id)
	{
		if(Yii::app()->request->isAjaxRequest)
		{
			echo CJSON::encode(array(
				'status'=>'success',
				'div'=>$this->renderPartial('_view', array('model'=>  $this->loadModel($id)), true)
			));
			exit;
		}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Calendar']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->calendar_pk));
		}
	...
	{
		if($id == null && !empty($_POST['Calendar']['calendar_pk']))
		{
			$id = $_POST['Calendar']['calendar_pk'];
		}
		$model=$this->loadModel($id);
		...
		if(isset($_POST['Calendar']))
		{
			...
			if($model->save())
			{
				if(Yii::app()->request->isAjaxRequest)
				{
					echo CJSON::encode(array(
						'status'=>'success',
						'div'=>"Calendar Successfully Updated."
					));
					exit;
				}
				$this->redirect(array('view','id'=>$model->calendar_pk));
