...
'users'=>array('*'),
	...
	{
		$model=new BatchSection;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['BatchSection']))
		{
			$model->attributes=$_POST['BatchSection'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('BatchSection');
	...
	{
		$model=new BatchSection('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BatchSection']))
			$model->attributes=$_GET['BatchSection'];
	...
	public function actionSession() {
		...
		public function actionCourse() {
				$model = CourseDepartment::model()->findAll("course_id=".$_POST['BatchSection']['course_id']);
                 //$data=CHtml::listData($model,'course_pk','course_name');
...
public function actionDisCoor() {
				$model = Batch::model()->findAll("batch_ref_course_pk=".$_POST['BatchSection']['course_id']);
  ...
  public function actionGroup() {
				$model = BatchGroup::model()->findAll("batch_id=".$_POST['BatchSection']['batch_id']);
                 //$data=CHtml::listData($model,'course_pk','course_name');
	...
	{
		$model=BatchSection::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='batch-section-form')
		{
