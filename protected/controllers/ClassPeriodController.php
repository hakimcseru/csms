...
'users'=>array('*'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ClassPeriod'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ClassPeriod');
	...
	{
		$model=new ClassPeriod('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ClassPeriod']))
			$model->attributes=$_GET['ClassPeriod'];
	...
	{
		$model=ClassPeriod::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='class-period-form')
		{
