...
'users'=>array('*'),
	...
	{
		$dataProvider=new CActiveDataProvider('StudentCollectionDetail');
	...
	{
		$model=new StudentCollectionDetail('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StudentCollectionDetail']))
			$model->attributes=$_GET['StudentCollectionDetail'];
	...
	{
		$model=StudentCollectionDetail::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='student-collection-detail-form')
		{
