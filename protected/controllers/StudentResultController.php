...
'users'=>array('*'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['StudentResult']))
		{
			$model->attributes=$_POST['StudentResult'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('StudentResult');
	...
	{
		$model=StudentResult::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='student-result-form')
		{
