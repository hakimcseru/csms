...
'users'=>array('*'),
	...
	{
		$model=new CertificateRecord;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['CertificateRecord']))
		{
			$model->attributes=$_POST['CertificateRecord'];
			if($model->save())
	...
	public function actionDisCoor() {
				$model = Batch::model()->findAll("batch_ref_course_pk=".$_POST['CertificateRecord']['course_id']);
	...
	public function actionCemester() {
				...
				$model = Course::model()->findByPk($_POST['CertificateRecord']['batch_ref_course_pk']);
				...
				else
				{
					...
					$clebel=CourseSemesterLebel::model()->find("course_id=".$_POST['CertificateRecord']['batch_ref_course_pk']." and semester_id=".$i);
					echo CHtml::tag('option',
	...
	public function actionCourse() {
				$model = CourseDepartment::model()->findAll("course_id=".$_POST['CertificateRecord']['course_id']);
  ...
  public function actionGroup() {
				$model = BatchGroup::model()->findAll("batch_id=".$_POST['CertificateRecord']['batch_id']);
                 //$data=CHtml::listData($model,'course_pk','course_name');
	...
	{
		$dataProvider=new CActiveDataProvider('CertificateRecord');
	...
	{
		$model=new CertificateRecord('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CertificateRecord']))
			$model->attributes=$_GET['CertificateRecord'];
	...
	{
		$model=CertificateRecord::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='certificate-record-form')
		{
