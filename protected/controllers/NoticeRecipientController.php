...
'users'=>array('*'),
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['NoticeRecipient']))
		{
			$model->attributes=$_POST['NoticeRecipient'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('NoticeRecipient');
	...
	{
		$model=new NoticeRecipient('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NoticeRecipient']))
			$model->attributes=$_GET['NoticeRecipient'];
	...
	{
		$model=NoticeRecipient::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='notice-recipient-form')
		{
