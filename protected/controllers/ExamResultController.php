...
'users'=>array('*'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ExamResult'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ExamResult');
	...
	{
		$model=new ExamResult('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ExamResult']))
			$model->attributes=$_GET['ExamResult'];
	...
	{
		$model=ExamResult::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='exam-result-form')
		{
